...
module.exports = {
  ...
  // ── Ticket messages (NO AI — staff handle tickets, players get pinged help) ──
  assistant: {
    // Shown under the per-type instructions when a ticket opens.
    openFooter: 'Ask anything here — a staff member will help you. 💙\n'
      + '📌 **Bans/appeals, player reports and applications are on our website:** {website}',
    // Sent (with a staff ping) when the player writes again and no staff has replied yet.
    stillWaiting: 'Thanks {user} — a staff member has been pinged and will get to you as soon as possible. 💙',
    // Short fallback opener — only used when the ticket answers don't match a known case.
    introShort: 'Hey {user}! 👋 Tell us what you need — a staff member will help you here.',
    ...
    intents: [
      ...
      { type: 'reply', keys: ['apply', 'application', 'become staff', 'apply as', 'how to apply', 'staff application', 'developer application', 'apply for staff', 'apply for dev', 'wanna be staff', 'want to be staff'],
        text: 'Applications (Staff, Developer and Media) are all handled on our website: {website} → **Apply** — pick the role there and follow the steps.' },
      { type: 'reply', keys: ['media', 'media rank', 'content creator', 'youtuber', 'streamer'],
        text: 'You can apply for the **Media rank** on our website: {website} → **Apply → Media**. Make sure you meet the requirements (views/viewers + the IP visible on screen + analytics as proof).' },
      ...
      { type: 'reply', keys: ['report a player', 'report player', 'report a user', 'report someone', 'report a hacker', 'report a cheater', 'sus', 'hacking', 'hacker', 'cheating', 'cheater', 'ban him', 'ban her', 'ban them', 'get banned', 'is hacking', 'wanna report', 'want to report'],
        text: 'Player reports are handled on our website: {website} → **Report a Player**. Please include their exact name and any proof (screenshot/clip) — staff review every report.' },
